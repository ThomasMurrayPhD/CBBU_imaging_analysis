% function to fit 3 level uHGF (using Iglesias parameters) with new toolbox
...
% Set Iglesias parameters
prc_config.logkamu(2) = log(1);
prc_config.logkasa(2) = 8;
prc_config.ommu(2) = -4;
prc_config.ommu(3) = 0;
...
save('cbbu_uHGF_3level_Iglesias_model_fits.mat', 'model_fits');
