...
# IMPORTANT: Need to have run MP2RAGE_prepare.sh, template_normalise.sh, dropout_MP2RAGE_to_template.sh 
# 
# Run MP2RAGE_prepare.sh, then create template, then template_normalise.sh, then dropout_MP2RAGE_to_template.sh, then this script.
#
# Preprocessing steps:
