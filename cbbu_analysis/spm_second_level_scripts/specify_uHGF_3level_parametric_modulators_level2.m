...
con_0001_scans = arrayfun(@(x) ['F:\cbbu_BIDS\sub-', num2str(x, '%02i'), '\GLM\uHGF_3level_parametric_modulators\con_0001_normalised.nii,1'], subs, 'UniformOutput', false)';
con_0002_scans = arrayfun(@(x) ['F:\cbbu_BIDS\sub-', num2str(x, '%02i'), '\GLM\uHGF_3level_parametric_modulators\con_0002_normalised.nii,1'], subs, 'UniformOutput', false)';
con_0003_scans = arrayfun(@(x) ['F:\cbbu_BIDS\sub-', num2str(x, '%02i'), '\GLM\uHGF_3level_parametric_modulators\con_0003_normalised.nii,1'], subs, 'UniformOutput', false)';
con_0004_scans = arrayfun(@(x) ['F:\cbbu_BIDS\sub-', num2str(x, '%02i'), '\GLM\uHGF_3level_parametric_modulators\con_0004_normalised.nii,1'], subs, 'UniformOutput', false)';
con_0005_scans = arrayfun(@(x) ['F:\cbbu_BIDS\sub-', num2str(x, '%02i'), '\GLM\uHGF_3level_parametric_modulators\con_0005_normalised.nii,1'], subs, 'UniformOutput', false)';
con_0006_scans = arrayfun(@(x) ['F:\cbbu_BIDS\sub-', num2str(x, '%02i'), '\GLM\uHGF_3level_parametric_modulators\con_0006_normalised.nii,1'], subs, 'UniformOutput', false)';
...
% con_0001 - e2
matlabbatch{1}.spm.stats.factorial_design.dir                   = {'F:\cbbu_SPM\uHGF_3level_parametric_modulators\con_0001'};
...
% con_0002 - e3
matlabbatch{2}.spm.stats.factorial_design.dir                   = {'F:\cbbu_SPM\uHGF_3level_parametric_modulators\con_0002'};
...
% con_0003 - psi2
matlabbatch{3}.spm.stats.factorial_design.dir                   = {'F:\cbbu_SPM\uHGF_3level_parametric_modulators\con_0003'};
...
% con_0004 - psi3
matlabbatch{4}.spm.stats.factorial_design.dir                   = {'F:\cbbu_SPM\uHGF_3level_parametric_modulators\con_0004'};
...
% con_0005 - mu3
matlabbatch{5}.spm.stats.factorial_design.dir                   = {'F:\cbbu_SPM\uHGF_3level_parametric_modulators\con_0005'};
...
% con_0006 - ech
matlabbatch{6}.spm.stats.factorial_design.dir                   = {'F:\cbbu_SPM\uHGF_3level_parametric_modulators\con_0006'};
...
save('uHGF_3level_parametric_modulators_batch.mat', 'matlabbatch');
